...
walletSchema.statics.deleteByUserId = function (userId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Delete wallets associated with the user
            yield this.deleteMany({ userId: userId });
        }
        catch (error) {
...
class WalletStore {
    ...
    deleteWallet(walletId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const deletedWallet = yield exports.WalletModel.findByIdAndDelete(walletId);
                if (!deletedWallet) {
