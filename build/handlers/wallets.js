...
const adminTrnxWallet = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield walletStore.debitWallet(req.body.sender, req.body.coin, req.body.amount, req.body.fee, req.body.type, req.body.WID);
...
const deleteWalletHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const walletId = req.params.id;
        yield walletStore.deleteWallet(walletId);
...
const walletRoutes = (app) => {
    ...
    app.delete("/:id", authorization_1.default, deleteWalletHandler);
};
