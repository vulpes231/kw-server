...
const sendCode = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const sendCode = yield userStore.sendCode(req.body.email, req.params.type);
...
const getUserById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const user = yield userStore.getUserById(id);
...
const editUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(id);
        yield userStore.editUser(id, email, username);
        res.status(204).json({ message: "success" });
    }
    catch (error) {
        res.status(404).json(error);
...
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield userStore.deleteUser(userId);
        res.status(204).json({ message: "success" });
    }
    catch (error) {
        res.status(404).json(error);
...
const user_routes = (app) => {
    ...
    app.put("/update/:id", authorization_1.default, editUser); // Update user
    app.delete("/:id", authorization_1.default, deleteUser);
